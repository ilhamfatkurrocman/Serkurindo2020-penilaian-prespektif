                                            ...
                                            <tbody>
                                                ...
                                                while ($dataLap = mysqli_fetch_array($hasilLap)) {
                                                    ...
                                                    $q = "SELECT a.ID_TOKO as took, a.NAMA_TOKO, d.ID_PRESPEKTIF, d.NAMA_PRESPEKTIF, c.ID_KRITERIA as idKri, c.NAMA_KRITERIA,
                                                            ...
                                                            (SELECT BOBOT$hehe
                                                                FROM PENILAIAN_KRITERIA WHERE ID_TOKO = 'TK001') as bobot,
                                                            (SELECT TARGET$hehe
                                                                FROM PENILAIAN_KRITERIA WHERE ID_TOKO = 'TK001') as target,
                                                            (SELECT SKOR$hehe
                                                                FROM PENILAIAN_KRITERIA WHERE ID_TOKO = 'TK001') as skor,
                                                            (SELECT RATA$hehe
                                                                FROM PENILAIAN_KRITERIA WHERE ID_TOKO = 'TK001') as tRataRata
